...
SECRET_KEY = 'django-insecure-nkfacts-change-this-in-production-xyz123'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates', BASE_DIR / 'podcasts' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT          = 587
EMAIL_USE_TLS       = True
EMAIL_HOST_USER     = 'nkfacts.podcast@gmail.com'
EMAIL_HOST_PASSWORD = 'smoy azeg gqnv wjwo'
